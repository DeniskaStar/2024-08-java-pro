...
public class AgreementServiceImplTest {
    ...
    void testAddAgreement() {
        ...
        expectedAgreement.setId(10L);
        expectedAgreement.setName("dummy");

        when(dao.save(any(Agreement.class))).thenReturn(expectedAgreement);

        // When
        Agreement actualAgreement = agreementServiceImpl.addAgreement(expectedAgreement.getName());

        // Then
        assertNotNull(actualAgreement);
